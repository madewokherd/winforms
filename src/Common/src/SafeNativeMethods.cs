...
namespace System.Windows.Forms
{
    internal static class SafeNativeMethods
    {
        ...
        private static extern IntPtr IntImageList_Read([MarshalAs(UnmanagedType.Interface)] IStream pstm);
...
#else
        [DllImport(ExternDll.Comctl32)]
        public static extern IntPtr ImageList_Read([MarshalAs(UnmanagedType.Interface)] IStream pstm);
#endif

        [DllImport(ExternDll.Comctl32)]
        public static extern bool ImageList_Write(HandleRef himl, [MarshalAs(UnmanagedType.Interface)] IStream pstm);

        [DllImport(ExternDll.Comctl32)]
        public static extern int ImageList_WriteEx(HandleRef himl, int dwFlags, [MarshalAs(UnmanagedType.Interface)] IStream pstm);
