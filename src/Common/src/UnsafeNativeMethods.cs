...
namespace System.Windows.Forms
{
    internal static class UnsafeNativeMethods
    {
        ...
        public static extern int CoGetClassObject(
            ...
            [In]
            ref Guid refiid,
			[MarshalAs(UnmanagedType.Interface)] out IClassFactory2 result);
        
        public static IClassFactory2 CoGetClassObject(
            [In]
            ref Guid clsid,
            int dwContext,
            int serverInfo,
        ...
        public static IPicture OleCreateIPictureIndirect([MarshalAs(UnmanagedType.AsAny)]object pictdesc, ref Guid iid, bool fOwn)
		{
			IntPtr result;
        ...
        [DllImport(ExternDll.Oleaut32, EntryPoint = "OleCreatePictureIndirect", ExactSpelling = true, PreserveSig = true)]
        public static extern int OleCreateIPictureDispIndirect([MarshalAs(UnmanagedType.AsAny)] object pictdesc, ref Guid iid, bool fOwn, [MarshalAs(UnmanagedType.Interface)] out IPictureDisp result);

        public static IPictureDisp OleCreateIPictureDispIndirect([MarshalAs(UnmanagedType.AsAny)] object pictdesc, ref Guid iid, bool fOwn)
		{
			IPictureDisp result;
        ...
        public static extern int OleCreatePictureIndirect(NativeMethods.PICTDESC pictdesc, [In]ref Guid refiid, bool fOwn, [MarshalAs(UnmanagedType.Interface)] out IPicture result);

        public static IPicture OleCreatePictureIndirect(NativeMethods.PICTDESC pictdesc, [In]ref Guid refiid, bool fOwn)
		{
			IPicture result;
        ...
        public static extern int StgOpenStorageOnILockBytes([MarshalAs(UnmanagedType.Interface)] ILockBytes iLockBytes, [MarshalAs(UnmanagedType.Interface)] IStorage pStgPriority, int grfMode, int sndExcluded, int reserved, [MarshalAs(UnmanagedType.Interface)] out IStorage result);

        public static IStorage StgOpenStorageOnILockBytes(ILockBytes iLockBytes, IStorage pStgPriority, int grfMode, int sndExcluded, int reserved)
		{
			IStorage result;
        ...
        [DllImport(ExternDll.Ole32, PreserveSig = true)]
        public static extern int GetHGlobalFromILockBytes([MarshalAs(UnmanagedType.Interface)] ILockBytes pLkbyt, out IntPtr result);

        public static IntPtr GetHGlobalFromILockBytes(ILockBytes pLkbyt)
		{
			IntPtr result;
        ...
        [DllImport(ExternDll.Ole32, ExactSpelling = true, CharSet = CharSet.Auto)]
        public static extern int RegisterDragDrop(HandleRef hwnd, [MarshalAs(UnmanagedType.Interface)] IOleDropTarget target);
        ...
        [DllImport(ExternDll.Ole32, PreserveSig = true)]
        public static extern int CreateILockBytesOnHGlobal(HandleRef hGlobal, bool fDeleteOnRelease, [MarshalAs(UnmanagedType.Interface)] out ILockBytes result);
        ...
        [DllImport(ExternDll.Ole32, PreserveSig = true)]
        public static extern int StgCreateDocfileOnILockBytes([MarshalAs(UnmanagedType.Interface)] ILockBytes iLockBytes, int grfMode, int reserved, [MarshalAs(UnmanagedType.Interface)] out IStorage result);
...
*/
        ...
        public interface IOleObject
        {
            ...
            [PreserveSig]
            int EnumVerbs([MarshalAs(UnmanagedType.Interface)] out IEnumOLEVERB e);
